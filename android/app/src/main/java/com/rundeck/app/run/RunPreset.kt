...
object RunPresetCatalog {
    val easy = RunPreset("easy", "EASY", "HR 135–145", "PACE 10:00-11:00 / HR 135-145", 10 * 60, 11 * 60, 135, 145)
    val steady = RunPreset("steady", "STEADY", "PACE 8:45–9:00", "PACE 8:45-9:00 / HR 135-150", 8 * 60 + 45, 9 * 60, 135, 150)
    val longRun = RunPreset("long_run", "LONG RUN", "10.0 MI   |   HR < 150   |   PACE 8:50–9:20", "PACE 8:50-9:20 / HR < 150", 8 * 60 + 50, 9 * 60 + 20, 135, 150)
